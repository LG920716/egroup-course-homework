...
const ProductCreate:React.FC<Props> = (props) => {
    ...
    const handleSubmit = () => {
        ...
        setProduct({desc:"",price :0, stock:0});
    }
  return (
    <div className={style.container}>
      <DialogContent>
          <TextField id="outlined-basic" label="產品描述" variant="outlined" name="desc" value={product.desc} onChange={handeChange}/><br/>
          <TextField id="outlined-basic" label="產品價格" variant="outlined" name="price" value={product.price} onChange={handeChange}/><br/>
